...
export const SectionHeaderFrame = styled.div`
  display: flex;
...
export const SocialPanel = styled.div<{ $backgroundColor?: string }>`
  position: absolute;
  left: 0;
  top: 0;
...
export const BrandName = styled.p<{ $mainColor?: string }>`
...
export const SectionRail = styled.nav`
  position: absolute;
  left: 4%;
  top: 15%;
  display: flex;
...
export const SectionDot = styled.button<{
  $size?: boolean;
...
export const RailConnector = styled.div`
  margin: 0;
  height: 16%;
  width: 1%;
...
export const LightModeIcon = styled(BsSun)`
  width: 30px;
  height: 30px;
  cursor: pointer;
