...
export const ProjectWorkspace = styled.div`
  height: 90%;
  max-height: 90%;
  width: 100%;
  display: flex;
...
export const ProjectMetadataLayout = styled.header`
  display: flex;
  flex-direction: row;
  width: 100%;
  height: 35%;
...
export const ProjectPreview = styled(ImagePlaceholder)`
  width: 45%;
  height: 100%;
  object-fit: cover;
  margin-right: 10px;
...
export const TechnologyHeading = styled.h2`
  margin-top: 2%;
  margin-bottom: 0;
  font-family: var(--font-sans);
  font-style: normal;
...
export const ProjectLead = styled.h3`
  font-style: normal;
  font-weight: 400;
  font-size: 16px;
  color: var(--ink-soft);
...
export const ProjectTimeline = styled.h4`
  font-style: normal;
  font-weight: 400;
  font-size: 13px;
  color: var(--muted);
...
export const SelectorPanel = styled.aside`
  height: 100%;
  flex: 1;
  max-width: 50%;
  display: flex;
...
export const TechnologyNames = styled.p`
  padding: 0;
  margin: 0;
  font-style: normal;
  font-weight: 400;
...
export const ProjectOption = styled.button`
  width: 80%;
...
export const ProjectOptionTitle = styled.span<{ $color?: string | undefined }>`
  font-family: var(--font-sans);
  font-style: normal;
  font-size: 20px;
  white-space: nowrap;
...
export const ProjectOptionIcon = styled.span<{
...
export const ContactToggle = styled.button`
  display: inline-flex;
  align-items: center;
  gap: 8px;
  color: var(--ink);
